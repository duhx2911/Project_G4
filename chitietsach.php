                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <div class="gia">
                                    ...
                                    <div class="giaban">Giá bán tại Parbo: <span
                                            class="giamoi font-weight-bold"><?php echo $result['giasale'] ?></span><span class="donvitien"></span></div>
                                    <div class="tietkiem">Tiết kiệm: <b></b> <span class="sale"><?php echo $result['sale'] ?></span>
                                    </div>
                                </div>
                    ...
                    <div class="product-description col-md-9">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active ml-3" id="nav-gioithieu" role="tabpanel"
                                ...
                                <p>
                                    <span><?php echo $result['chitietsach']?>
                                    </span>
                                </p>
                                <p>
