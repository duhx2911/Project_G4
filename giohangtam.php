<div class="col-md-8 cart">
                                        <div class=" py-3 pl-3">
                                            <h6 class="header-gio-hang">GIỎ HÀNG CỦA BẠN <span></span></h6>
                                            <?php foreach ($_SESSION["cart"] as $spgh) { ?>
                                                <div class="cart-list-items">
                                                    <div class="cart-item d-flex">
                                                        <a href="chitiet.php?id=<?php echo $spgh["id"] ?>" class="img">
                                                            <img src="<?php echo $spgh["img"] ?>" class="img-fluid" alt="anhsp1">
                                                        </a>
                                                        <div class="item-caption d-flex w-100">
                                                            <div class="item-info ml-3">
                                                                <a href="chitiet.php?id=<?php echo $spgh["id"] ?>" class="ten"><?php echo $spgh["name"] ?></a>
                                                                <div class="soluong d-flex">
                                                                    <div class="input-number input-group mb-3">
                                                                        <div class="input-group-prepend">
                                                                            <span class="input-group-text btn-spin btn-dec">-</span>
                                                                        </div>
                                                                        <input type="text" value="<?php echo $spgh["number"] ?>" class="soluongsp  text-center">
                                                            ...
                                                            <div class="item-price ml-auto d-flex flex-column align-items-end">
                                                                <div class="giamoi"><?php echo $spgh["giasale"] ?></div>
                                                                <div class="giacu"><?php echo $spgh["giagoc"] ?></div>
                                                    ...
                                                    <div class="col-md-5 offset-md-4">
                                                        <div class="tonggiatien">
                                                            <div class="group d-flex justify-content-between">
                                                                ...
                                                                <?php 
                                                                    $tong = 0;
                                                                foreach ($_SESSION["cart"] as $ttgh) {
                                                                        $tong += $ttgh["giasale"]*$ttgh["number"];  
                                                                 };
                                                                 print_r($tong);
                                                                 ?>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="step3contentid" class="collapse in" role="tabpanel"
                                                ...
                                                <div class="card-body" style="padding: 15px;">
                                                    ...
                                                    <div class="pttt">
                                                        ...
                                                        <div class="option option2">
                                                            ...
                                                            <p class="mt-4">- Quý khách chỉ chuyển khoản khi được xác nhận có đủ
                                                                sách qua điện thoại từ Parbo.</p>
                                                    ...
                                                    <hr>
                                                    <form action="thanhtoangiohang.php" method="POST" >

                                                        <button name='thanhtoan' class="btn btn-lg btn-block btn-checkout text-uppercase text-white"
