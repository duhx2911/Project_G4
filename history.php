    ...
    <section class="content my-3">
        <div class="container">
            <div class="cart-page bg-white">
                <div class="row">
                    <!-- giao diện giỏ hàng đã mua hàng -->
                    <div class="col-md-8 cart">
                        <div class=" py-3 pl-3">
                            <?php foreach($result as $damua) { ?>
                                <div class="cart-list-items">
                                    <div class="cart-item d-flex">
                                        <a href="product-item.html" class="img">
                                            <img src="<?php echo $damua['img'] ?>" class="img-fluid" alt="anhsp1">
                                        </a>
                                        <div class="item-caption d-flex w-100">
                                            <div class="item-info ml-3">
                                                <a href="product-item.html" class="ten"><?php echo $damua['tensach'] ?></a>
                                                <div class="soluong d-flex">
                                                    <div class="input-number input-group mb-3">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text btn-spin btn-dec">-</span>
                                                        </div>
                                                        <input type="text" value="<?php echo $damua['soluong'] ?>" class="soluongsp  text-center">
                                                        <div class="input-group-append">
                                            ...
                                            <div class="item-price ml-auto d-flex flex-column align-items-end">
                                                <div class="giamoi"><?php echo $damua['giasale'] ?> ₫</div>
                                                <div class="giacu"><?php echo $damua['giagoc'] ?> ₫</div>
                                                <span >Tổng cộng: <?php echo $damua['tongtien'] ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
