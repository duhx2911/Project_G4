        ...
        <div class="container">
            <div class="cart-page bg-white">
                <div class="row">
                    ...
                    <!-- giao diện giỏ hàng ko có hàng (phần comment màu xanh bên dưới là phần 2 sản phẩm trong giỏ hàng nhưng giờ đã demo bằng jquery) -->
                            <?php
                                if(!isset($_SESSION['cart']))
                                {
                                    echo '
